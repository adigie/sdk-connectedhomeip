...
class LayerImplFoo : public LayerFoo
{
public:
    LayerImplFoo() = default;
    ~LayerImplFoo() override { VerifyOrDie(mLayerState.Destroy()); }
    ...
    //
    // protected:
    //     static SocketEvents SocketEventsFromFDs(int socket, const fd_set & readfds, const fd_set & writefds, const fd_set &
    //     exceptfds);
    //
