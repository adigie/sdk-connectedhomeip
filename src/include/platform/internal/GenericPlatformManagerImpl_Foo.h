...
class GenericPlatformManagerImpl_Foo : public GenericPlatformManagerImpl<ImplClass>
{
protected:
    ...
    explicit GenericPlatformManagerImpl_Foo(ThreadStack stack) : mChipThreadStack(stack) {}
...
extern template class GenericPlatformManagerImpl_Foo<PlatformManagerImpl>;
