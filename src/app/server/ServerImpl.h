...
public:
    ...
    ServerImpl(Server & parent) : mParent{ parent } {}
...
private:
    ...
    /**
     * @brief Called at ServerImpl::Init time to resume persisted subscriptions if the feature flag is enabled
     */
    ...
    public:
        ...
        CHIP_ERROR Init(ServerImpl * server)
        {
